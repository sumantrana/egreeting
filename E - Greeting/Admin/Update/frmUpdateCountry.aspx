<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"   AutoEventWireup="true" CodeFile="frmUpdateCountry.aspx.cs" Inherits="Admin_Update_frmUpdateCountry" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table border="0" cellpadding="2" cellspacing="2" align="center" width="80%">
        ...
        <tr>
            <td align="center" colspan="2">
                <asp:Label ID="lblMsg" runat="server" Font-Bold="True" ForeColor="Red" Width="74px"></asp:Label></td>
        </tr>
    </table>
    </td>
    </tr>
