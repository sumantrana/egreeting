<%@ Page Language="C#" MasterPageFile="~/MasterPage.master"   AutoEventWireup="true" CodeFile="frmUpdateState.aspx.cs" Inherits="Admin_Update_frmUpdateState" %>
...
<td valign="top">
    <table align="center" border="0" cellpadding="0" cellspacing="0" width="75%">
        <tr>
            <td align="center" colspan="2" style="font-weight: bold; font-size: 13pt; height: 19px;">
                Update State</td>
        </tr>
        <tr>
        ...
        <tr>
            <td align="left" style="font-weight: bold; height: 22px;" width="30%">
                Select Country:</td>
